...
static void init_ardupilot()
{
  ...
  #warning "Invalid CONFIG_SONAR_SOURCE"
    ...
    // a MUX is used
    gcs[1].setup_uart(hal.uartD, map_baudrate(g.serial1_baud, SERIAL1_BAUD), 128, 128);
#endif
#if MAVLINK_COMM_NUM_BUFFERS > 2
    gcs[2].setup_uart(hal.uartC, map_baudrate(g.serial2_baud, SERIAL2_BAUD), 128, 128);
#endif
